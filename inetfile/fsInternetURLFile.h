...
class fsInternetURLFile : public fsSpeaking
{
  public:
	...
	fsInternetResult OpenAnotherRequestOnServer(LPCSTR pszPath, UINT64 uStartPosition, UINT64 uUploadPartSize,
	...
	fsInternetResult OpenEx(INTERNET_SCHEME scheme, LPCSTR pszHostName, LPCSTR pszUser, LPCSTR pszPassword,
	...
	fsInternetResult Open(INTERNET_SCHEME scheme, LPCSTR pszHostName, LPCSTR pszUser, LPCSTR pszPassword,
	                      INTERNET_PORT port, LPCSTR pszPath, UINT64 uStartPosition,
	                      BOOL bSendHTTPBasicAuthImmediately = FALSE);

	fsInternetResult QuerySize(INTERNET_SCHEME scheme, LPCSTR pszHostName, LPCSTR pszUser, LPCSTR pszPassword,
	                           INTERNET_PORT port, LPCSTR pszPath, BOOL bSendHTTPBasicAuthImmediately);
