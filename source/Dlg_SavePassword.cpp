...
CDlg_SavePassword::CDlg_SavePassword(CWnd* pParent) : CDialog(CDlg_SavePassword::IDD, pParent)
{
...
{
	if (IsDlgButtonChecked(IDC_DONTSUGGEST) == BST_CHECKED) _App.SM_PwdsManualAddition(TRUE);
