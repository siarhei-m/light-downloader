...
typedef HRESULT(WINAPI* fntDrawThemeBackground)(HTHEME hTheme, HDC hdc, int iPartId, int iStateId, const RECT* pRect,
...
class vmsTheme
{
  public:
	...
	HRESULT DrawThemeBackground(HTHEME hTheme, HDC hdc, int iPartId, int iStateId, const RECT* pRect,
	                            const RECT* pClipRect);
