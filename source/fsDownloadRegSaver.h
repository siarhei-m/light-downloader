...
class fsDownloadRegSaver
{
  ...
  public:
	// fsDLLoadResult Load (t_downloads* vDownloads, LPCSTR pszFileName, BOOL bDontLoadIfTooLarge, fsDLLoadFromType lt =
	// DLLFT_SAV, BOOL bErrIfNotExists = FALSE);
	fsDLLoadResult Load(vmsDownloadList& vDownloads, LPCSTR pszFileName, BOOL bDontLoadIfTooLarge,
	                    fsDLLoadFromType lt = DLLFT_SAV, BOOL bErrIfNotExists = FALSE);
