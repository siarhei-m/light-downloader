...
void CSiteManager_PasswordsPage::ApplyLanguage()
{
	fsDlgLngInfo lnginfo[] = {
	    fsDlgLngInfo(IDC_USE, L_USESMTOSTOREPWDS),        fsDlgLngInfo(IDC_ASK, L_ASKMETOSAVEPWDS),
	    fsDlgLngInfo(IDC_DONTASK, L_DONTASKMETOSAVEPWDS), fsDlgLngInfo(IDC_AUTODEL, L_DELPWDSBEFOREEXIT),
