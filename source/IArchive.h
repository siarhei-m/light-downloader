...
#define ARCHIVE_INTERFACE_SUB(i, base, x)                                                                              \
	DEFINE_GUID(IID_##i, 0x23170F69, 0x40C1, 0x278A, 0x00, 0x00, 0x00, 0x06, 0x00, x, 0x00, 0x00);                     \
...
{
	STDMETHOD(GetUpdateItemInfo)(UInt32 index, Int32 * newData, Int32 * newProperties, UInt32 * indexInArchive) PURE;
	STDMETHOD(GetProperty)(UInt32 index, PROPID propID, PROPVARIANT * value) PURE;
