...
BOOL CComboBox_Ex::Create(CWnd* pParent)
{
	...
	CComboBox::Create(WS_CHILD | WS_VISIBLE | CBS_AUTOHSCROLL | CBS_DROPDOWN | WS_VSCROLL, rc, pParent, 0x67909);
...
LRESULT CComboBox_Ex::OnGetDroppedState(WPARAM, LPARAM)
{
	...
	if (lRes == FALSE) GetParent()->PostMessage(WM_COMMAND, m_uReturnID, 0);
