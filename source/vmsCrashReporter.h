...
class vmsCrashReporter
{
  ...
  protected:
	static void GenerateXml(LPCTSTR ptszAppName, LPCTSTR ptszVersion, LPCTSTR ptszDescription, LPCTSTR ptszFaultModule,
	                        DWORD_PTR dwpCrashAddr, LPCSTR pszAdditionalXmlData, std::string& strResult);
