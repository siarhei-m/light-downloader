...
CCBD_SeeResultsDlg::CCBD_SeeResultsDlg(CWnd* pParent) : CDialog(CCBD_SeeResultsDlg::IDD, pParent)
{
	m_bl = NULL;
}
...
BOOL CCBD_SeeResultsDlg::OnInitDialog()
{
	...
	for (int i = 0; i < m_bl->get_ResultCount(); i++) m_wndList.InsertItem(i, m_bl->get_Result(i));
