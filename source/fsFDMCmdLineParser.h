...
class fsFDMCmdLineParser
{
  ...
  protected:
	...
	//	const std::vector <vmsKnownBrowsers::Browser>& getBrowsersToInstallIntegration (bool bInstall) const {return
	//bInstall ? m_vBrowsersToInstallIntegration : m_vBrowsersToDeinstallIntegration;}
