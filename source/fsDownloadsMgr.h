...
class fsDownloadsMgr
{
  ...
  public:
	...
	BOOL AskToDeleteDownloadFile(vmsDownloadSmartPtr dld, BOOL bNoCancel, fsDeleteDownloadReaction& enDDRResult,
	                             bool& bApplyForAll);

	void GetDDRs(DLDS_LIST_REF vDlds, BOOL bDeleteCompletedFilesAlso, BOOL bNoCancel,
  ...
  protected:
	...
	int DeleteDownloads2(DLDS_LIST* vDlds, BOOL bByUser, BOOL bDontConfirmFileDeleting, BOOL bDontDeleteFiles = FALSE,
	                     BOOL* pbNeedStop = NULL, int* piProgress = NULL);
